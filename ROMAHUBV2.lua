--[[
    Aimbot GUI for Roblox
    Features: Toggle, Ignore Team, Wallbang, Offsets, Draggable GUI
--]]
...
IgnoreTeamButton.MouseButton1Click:Connect(function()
    ...
    local tweenInfo = TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
    local tween = TweenService:Create(IgnoreTeamIndicator, tweenInfo, {
        BackgroundColor3 = (IgnoreTeamEnabled and Color3.fromRGB(0, 255, 0)) or Color3.fromRGB(255, 0, 0)
    })
    tween:Play()
end)
...
WallbangButton.MouseButton1Click:Connect(function()
    ...
    local tweenInfo = TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
    local tween = TweenService:Create(WallbangIndicator, tweenInfo, {
        BackgroundColor3 = (WallbangEnabled and Color3.fromRGB(0, 255, 0)) or Color3.fromRGB(255, 0, 0)
    })
    tween:Play()
end)
...
local function isVisible(target)
    ...
    local ray = Ray.new(
        ...
        (head.Position - LocalPlayer.Character.Head.Position).unit * 300
    )
